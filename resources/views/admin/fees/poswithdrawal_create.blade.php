                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{route('admin.fee.poswithdrawal.create')}}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="fee_percent" type="tel" class="form-control"
                                                           required>
                                                </div>

                                                <div class="form-group">
                                                    <label>Minimum Fee</label>
                                                    <input name="minimum_fee" type="tel" class="form-control"
                                                           required>
                                                </div>

                                                <div class="form-group">
                                                    <label>Capped Fee</label>
                                                    <input name="capped_fee" type="tel" class="form-control"
                                                           required>
                                                </div>
